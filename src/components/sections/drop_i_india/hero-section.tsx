  ...
  return (
    <section className="relative isolate">
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-stretch gap-8 px-4 md:grid-cols-2 md:gap-10">
        <div className="order-2 flex flex-col justify-start md:order-1 sm:pt-[120px]">
          <h1 className="text-pretty font-sans text-3xl font-extrabold leading-tight text-[#FE7743] sm:text-5xl">
        ...
        <div className="order-1 md:order-2">
          <div className="sm:w-[1062px] sm:h-[708px] w-full rotate-[-1.651deg] flex-shrink-0 aspect-[3/2]">
            <Image
